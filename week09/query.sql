...
INSERT INTO Languages VALUES(7,'C++','header files',0,'Here be dragons! It`s C++ time. Go to the C++ folder.')


INSERT INTO Languages VALUES(8,'JavaScript','Douglas Crockford',0,'NodeJS time. Go to JavaScript folder and Node your way!')

ALTER TABLE Languages ADD 'rating' int CHECK ('rating' BETWEEN 1 AND 9)

UPDATE Languages SET rating = 1 WHERE id=1


UPDATE Languages SET rating = 0 WHERE id=2

UPDATE Languages SET rating = 3 WHERE id=3


UPDATE Languages SET rating = 4 WHERE id=4


UPDATE Languages SET rating = 5 WHERE id=5


UPDATE Languages SET rating = 6 WHERE id=6


UPDATE Languages SET rating = 7 WHERE id=7


UPDATE Languages SET answered = 1 WHERE language="Python"


UPDATE Languages SET answered = 1 WHERE language="Go"


SELECT language FROM Languages WHERE answer= '200 OK'


SELECT language FROM Languages WHERE answer= 'Lambda'